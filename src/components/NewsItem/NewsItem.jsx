  ...
  return (
    <div className='w-[80%] md:w-1/5 md:h-[350px] h-auto md:m-2 m-8 border border-gray-400 shadow-md shadow-slate-900 bg-black text-white rounded-md hover:scale-105 hover:duration-200 hover:bg-[#f7ba02] hover:text-black'>
            ...
            <div className='flex flex-col gap-y-2 p-2'>
                <h5 className='font-bold md:text-xl text-4xl line-clamp-5 md:line-clamp-3'>{title}</h5>
                <p className='md:text-sm text-xl text-gray-600 line-clamp-5 md:line-clamp-3'>{description? description :`To Read more about this news article click to "Read more" given below. Happy reading`}</p>
                <a href={newsUrl} target='_blank' className='text-sm cursor-pointer text-gray-600' >Read more</a>
